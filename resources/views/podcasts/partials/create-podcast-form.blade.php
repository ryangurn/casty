<x-jet-form-section submit="createTeam">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="author[name]" value="{{ __('Author Name') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="author[email]" value="{{ __('Author Email') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="owner[name]" value="{{ __('Owner Name') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="owner[email]" value="{{ __('Owner Email') }}" />
